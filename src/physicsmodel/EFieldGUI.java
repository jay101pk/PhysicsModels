...
public class EFieldGUI implements Initializable{
    //this class is repsonsible for taking the field info and displaying it 3d
    private EField f= new EField(19,19,19);
    private int s =0,t=0;
    @FXML
    ...
    private void handleAddCharge(){
        ...
        int[] p={x,y,z};
        Charge c = new Charge(p,q*Math.pow(10, -9),new Vec3d(0,0,0));
        f.addCharge(c);
