 ...
 */
public class EField {//this class creates and hold the info of an electric field created by charges
    public final static double K = 8.9875517873681764*Math.pow(10, 9);  
    private ArrayList<Charge> charges;
    private Vec3d[][][] field;
    
    public EField(int x,int y,int z){
                    ...
                    if(!taken){
                        for(Charge q:charges){
                            ...
                            */
                            ...
                            Vec3d temp=new Vec3d(r.x,r.y,r.z);
                            temp.mul(K*q.getChargeAmount()/Math.pow(r.length(),2));
